...
body_classefire = cv2.CascadeClassifier("C:\Users\giova\Downloads\PRO_1-1_C106_TemplateProjeto-main\PRO_1-1_C106_TemplateProjeto-main\haarcascade_fullbody.xml")
...
while True:
    ...
    bodies=body_classefire.detectMultiScale(cinza,1.2,3)
